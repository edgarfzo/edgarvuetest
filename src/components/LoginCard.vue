<template>
  <v-card class="mx-auto pa-12 pb-8" max-width="448" rounded="lg" :color="color">
    <b>Portal for {{ type }} enterprises</b>
    <div class="text-subtitle-1 text-medium-emphasis">Account</div>
    <v-text-field density="compact" placeholder="Email address" prepend-inner-icon="mdi-email-outline" variant="outlined"
    ...
    <v-text-field :append-inner-icon="visible ? 'mdi-eye-off' : 'mdi-eye'" :type="visible ? 'text' : 'password'"
      ...
      v-model="password" @click:append-inner="visible = !visible"></v-text-field>
    ...
    <v-card-text class="text-center">
      <v-btn class="text-blue text-decoration-none" @click="register()">
